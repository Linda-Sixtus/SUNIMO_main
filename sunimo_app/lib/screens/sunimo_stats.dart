  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      body: Container(
              ...
              colors: [
              const Color.fromARGB(255, 254, 221, 255).withAlpha(255), // Startfarbe (oben)
              const Color.fromARGB(255, 226, 242, 252).withAlpha(255), // Endfarbe (unten)
              ],
            ),
            ),
            child: Center(
              ...
              Row(
                ...
                children: [
                  ...
                  decoration: BoxDecoration(
                      color: Color.fromARGB(255, 255, 255, 255).withAlpha(255), // Endfarbe (unten)
                      border: Border.all(
                    ...
                    children: [
                        ...
                        color: Color.fromARGB(255, 156, 128, 193).withAlpha(255),
                        fontSize: 45,
                        ),
                        ),
                        InkWell(
              ...
              Padding(
                ...
                children:[
                    ...
                    Container(
                      ...
                      child: 
                        Text(sunimo.age == 1 ? "1 Tag" : "${sunimo.age} Tage",
                          style:
                            TextStyle(
                  ...
                  SizedBox(height: 20,),
                  StatusBarWidget("Gesundheit", color: Color.fromARGB(255, 50, 235, 220), value: sunimo.gesundheit),
                  SizedBox(height: 10,),
                  StatusBarWidget("Hunger", color: Color.fromARGB(255, 137, 196, 244), value: sunimo.hunger),
                  SizedBox(height: 10,),
                  StatusBarWidget("Hygiene", color: Color.fromARGB(255, 240, 161, 218), value: sunimo.hygiene),
                  SizedBox(height: 10,),
                  StatusBarWidget("Notdurft", color: Color.fromARGB(255, 247, 239, 173), value: sunimo.notdurft),
                  SizedBox(height: 10,),
